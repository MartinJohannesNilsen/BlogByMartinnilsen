...
export const _filterListOfStoredPostsOnPublished = (
  ...
  if (filter === "published") {
    ...
    if (typeof window !== "undefined" && window.localStorage) {
      ...
      return data.filter(
        (post) => saved && saved.includes(post.id) && post.published
      );
    }
  }
  return data;
    ...
    if (!tag) {
      ...
      setStatePosts(
        _filterListOfStoredPostsOnTag(
          posts,
          _getCaseInsensitiveElement(tags, tag)!
        )
      );
    }
  }, [tag]);
    ...
    >
      <Navbar
        posts={
          isAuthorized
            ? posts
            : _filterListOfStoredPostsOnPublished(posts, "published")
        }
