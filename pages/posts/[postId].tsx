...
import { FirestorePost, Post, ReadArticleViewProps } from "../../types";
...
import AvatarMJN from "../../public/assets/img/ProfileCutoutSquare.png";
...
export const getStaticProps = async (context: any) => {
  ...
  if (!post) return { redirect: "/", permanent: false };
