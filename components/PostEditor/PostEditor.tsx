...
import {
  deleteImage,
  uploadImage,
} from "@/data/middleware/media/imageStore/actions";
import {
  addPostsOverview,
  deletePostsOverview,
  updatePostsOverview,
} from "@/data/middleware/overview/actions";
import {
  addPost,
  deletePost,
  updatePost,
} from "@/data/middleware/posts/actions";
...
const PostEditor = ({ post, id }: ManagePostPageProps) => {
  ...
  const [automaticallySetUpdatedAt, setAutomaticallySetUpdatedAt] =
    useState(true);
            ...
            if (postId) {
              ...
              addPostsOverview({
                ...
                if (overviewWasAdded) {
                  ...
                  window.history.replaceState(null, "", `/cms/edit/${postId}`); // Update URL without refreshing. Will allow for browser refresh to include postId in browser URL.
                } else {
                  enqueueSnackbar("An error occurred!", {
                    variant: "error",
                    preventDuplicate: true,
              ...
              >
                      ...
                      <Box display="flex" gap={0.5} alignItems="center">
                        ...
                        <Box sx={{ width: "180px" }}>
                          <input
                            ...
                            // }}
                            value={getTimeZoneUTCFormatString(
                            ...
                            onChange={(e) => {
                              setData({
                                ...data,
                                createdAt: new Date(e.target.value).valueOf(),
                              });
                              resetSavedAndRevalidated();
                            }}
                          />
                          ...
                          {automaticallySetUpdatedAt ? (
                            <input
                              ...
                              onChange={(e) => {
                                setData({
                                  ...data,
                                  updatedAt: new Date(e.target.value).valueOf(),
                                });
                              }}
                            />
                          ) : data.updatedAt ? (
                          ...
                          menuItems={[
                            {
                              ...
                              onClick: () => {
                                setData({
                                  ...data,
                                  updatedAt: post!.updatedAt || data.createdAt,
                                });
                ...
                {postId && (
                  <>
                    ...
                    <Grid item xs={9} md={10}>
                      {data.ogImage.hasOwnProperty("fileRef") &&
                      data.ogImage.fileRef ? (
                        // Image exists
                              ...
                              },
                              {
                                ...
                                onClick: async () => {
                                  ...
                                  if (response.code === 200) {
                                    ...
                                    enqueueSnackbar(
                                      `Open Graph Image successfully deleted`,
                                      {
                                        variant: "success",
                                        preventDuplicate: true,
                                      }
                        ...
                        <>
                          <input
                            ...
                            onChange={async (e) => {
                              ...
                              if (uploadResponse.data) {
                                const details = await getImageBlurhash(
                                ...
                                if (details && details.data) {
                                  ...
                                  enqueueSnackbar(
                                    `Open Graph Image: Could not fetch image details`,
                                    {
                                      variant: "error",
                                      preventDuplicate: true,
                                    }
                                ...
                                enqueueSnackbar(
                                  `(${uploadResponse.code}) ${uploadResponse.reason}`,
                                  {
                                    variant: "error",
                                    preventDuplicate: true,
                                  }
                          ...
                          <label htmlFor="fileInput">
                            ...
                            >
                              <UploadFile
                                sx={{ mr: "2px", fontSize: isMobile ? 18 : 15 }}
                              />
                              Select File
                            </Button>
                          </label>
                  ...
                  <Box sx={{ zIndex: 5 }}>
                    <CreatableSelect
                      ...
                      onChange={(array) => {
                        setData({
                          ...data,
                          tags: array.map((item) => item.value),
                        });
                        resetSavedAndRevalidated();
                      }}
