...
export const SearchModal = ({
  ...
  let actions: SearchActionProps[] = [
    ...
    },
    {
      ...
      onClick: () => {
        userSignOut(
          window.location.pathname === "/account" ? "/" : undefined,
          true
        );
      },
    ...
    },
    {
      ...
      iconElement: (
        <SettingsBrightness sx={{ color: theme.palette.text.primary }} />
      ),
    },
    {
    ...
    },
    {
      ...
      iconElement: (
        <TableRowsSharp sx={{ color: theme.palette.text.primary }} />
      ),
      requirement: () => {
        return setCardLayout != null;
      },
    ...
    if (isActions) {
      if (textFieldValue === "") {
        ...
        const bestMatch = matchSorter(
          actions.filter(
            (action) =>
              action.requirement == null || action.requirement() === true
          ),
          textFieldValue,
          {
  ...
  const modalStyle = {
    ...
    rowGap:
      (isActions && matchedActions.length !== 0) ||
      (!isActions && matchedPosts.length !== 0)
        ? "5px"
        : null,
          ...
          sx={{
            ...
            "@keyframes pulse": {
              "0%": {
                transform: "scale(1)",
                MozBoxShadow:
                  "0 0 0 0 " + (theme.palette.secondary.main + "40"),
              ...
              "60%": {
                MozBoxShadow:
                  "0 0 0 40px " + (theme.palette.secondary.main + "00"),
                boxShadow:
                  "0 0 0 40px " + (theme.palette.secondary.main + "00"),
              },
              "100%": {
                MozBoxShadow:
                  "0 0 0 0 " + (theme.palette.secondary.main + "00"),
          ...
          <Box className={`${isPulsating ? "pulsate" : ""}`}>
            <Box sx={modalStyle}>
              ...
              {isActions ? (
                ...
                <List sx={{ paddingY: 0 }}>
                  {matchedActions!.map(
                    (action: SearchActionProps, index: number) => (
                      <ListItem
                        key={index}
                        sx={{
